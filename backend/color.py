...
def wavelet_color_fix(target: torch.Tensor, source: torch.Tensor, downsample: int = 1) -> torch.Tensor:
    ...
    Color is a low-frequency signal. throughput can blur at 1/4 resolution and
    upsample the residual; the high-frequency detail still comes from the SR frame.
    """
