...
class DinoVisionTransformer(nn.Module):
    def __init__(self, img_size=518, patch_size=14, embed_dim=1024, depth=24, num_heads=16, mlp_ratio=4.0):
        ...
        # Tile geometry is identical for every tile of every frame; memoize
        # the bicubic pos-embed resize per (h, w, dtype) instead of redoing it
        # per DINO call. Bound the map so resolution sweeps cannot grow it.
